...
public class ItemAdapterP0 extends ArrayAdapter{
    private final Context context;
    private final int idLinha;
    private final int[] ListaID;

    public ItemAdapterP0(@NonNull Context context, @LayoutRes int idLinha, int[]listaID ) {
    ...
    public View getView(int position , View convertView , ViewGroup parent){
        ...
        TextView texto=  (TextView) Linha.findViewById(R.id.nomeListap0);
        texto.setText(ModelP0.getItemP0(position).nome);
        ImageView imagem =(ImageView) Linha.findViewById(R.id.imagemListap0);
        String caminho= ModelP0.getItemP0(position).nome;
  ...
  imagem.setImageResource(id);
    ...
    @Override
    public  int getCount(){return ModelP0.items.size();}
}
